package mx.edu.utng.mmacias.subirfotos;
...
public class MainActivitySubirImagen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subir_fotos);
    ...
    private void showOptions() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MainActivitySubirImagen.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == MY_PERMISSIONS){
            if(grantResults.length == 2 && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(MainActivitySubirImagen.this, "Permisos aceptados", Toast.LENGTH_SHORT).show();
    ...
    private void showExplanation() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivitySubirImagen.this);
